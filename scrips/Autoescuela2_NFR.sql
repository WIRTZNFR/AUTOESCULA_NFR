...
CREATE TABLE Clase 
    (
     ...
     Vehículo_Id_vehiculo INTEGER NOT NULL , 
...
CREATE TABLE Factura 
    (
     ...
     Matrícula_Id_matricula INTEGER NOT NULL 
    )
GO

ALTER TABLE Factura ADD CONSTRAINT Factura_PK PRIMARY KEY CLUSTERED (Id_Factura, Matrícula_Id_matricula)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Matricula ADD CONSTRAINT Matrícula_PK PRIMARY KEY CLUSTERED (Id_matricula)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Vehiculo ADD CONSTRAINT Vehículo_PK PRIMARY KEY CLUSTERED (Id_vehiculo)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Clase 
    ADD CONSTRAINT Clase_Vehículo_FK FOREIGN KEY 
    ( 
     Vehículo_Id_vehiculo
    ) 
    REFERENCES Vehiculo 
    ( 
     Id_vehiculo 
...
ALTER TABLE Factura 
    ADD CONSTRAINT Factura_Matrícula_FK FOREIGN KEY 
    ( 
     Matrícula_Id_matricula
    ) 
...
ALTER TABLE Matricula 
    ADD CONSTRAINT Matrícula_Alumno_FK FOREIGN KEY 
    ( 
     Alumno_DNI_Alumno
    ) 
    REFERENCES Alumno 
...
ALTER TABLE Vehiculo 
    ADD CONSTRAINT Vehículo_Local_FK FOREIGN KEY 
    ( 
     Local_Id_local
    ) 
    REFERENCES Local 
