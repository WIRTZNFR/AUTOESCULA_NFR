...
CREATE TABLE Factura 
    (
     ...
     Forma_pago_Id_pago2 INTEGER NOT NULL , 
     Forma_pago_numero_tarjeta1 INTEGER NOT NULL , 
     Matricula_Id_matricula2 INTEGER NOT NULL 
    )
GO

ALTER TABLE Factura ADD CONSTRAINT Factura_PK PRIMARY KEY CLUSTERED (Id_Factura, Matricula_Id_matricula)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Factura 
    ADD CONSTRAINT Factura_Forma_pago_FKv2 FOREIGN KEY 
    ( 
     Forma_pago_Id_pago2, 
     Forma_pago_numero_tarjeta1
    ) 
    REFERENCES Forma_pago 
    ( 
     Id_pago , 
...
ALTER TABLE Factura 
    ADD CONSTRAINT Factura_Matricula_FKv2 FOREIGN KEY 
    ( 
     Matricula_Id_matricula2
    ) 
    REFERENCES Matricula 
    ( 
     Id_matricula 
